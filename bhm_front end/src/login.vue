<template>
  <div class="_452c3ec4 d68c66a8 index_background">
    <div>
        ...
        <div class="_94d452dc">
          <section class="_2b1f4808 bg-white br3">
            <div class="_66e908c6">
              ...
              <form id="login"
                    class="ma0">
                <h1 class="aa630ec5 f3 fw6 pb3 pt0 mt0 mb3 black-70 b--black-10 bb">Sign In</h1>
  ...
  methods: {
    login () {
      this.$axios.post('/api/user/login', {
        ...
        console.log(data)
        if (data.data.isLoginSuccess === 1) {
          window.sessionStorage.setItem('isLoginSuccess', '1')
          this.$message.success('Login successful!', 2, () => {
            this.$router.push('/user')
          }
          )
        } else {
          this.$message.warning('Please enter the correct username and password!')
        }
      }).catch(() => {
        this.$message.warning('Please enter the correct username and password!')
      })
